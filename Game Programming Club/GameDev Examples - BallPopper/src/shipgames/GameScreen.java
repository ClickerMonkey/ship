...
public abstract class GameScreen extends JPanel
{
	...
	// The parent window that contains this game screen panel.
	protected JFrame window;
	
	// The flag for whether the game is running or not.
	protected volatile boolean isRunning = true;
	// The lock to wait for the game to stop.
	 ...
	 */
	public static void showWindow(final GameScreen gameScreen, String title)
	{
		if (gameScreen == null)
			return;

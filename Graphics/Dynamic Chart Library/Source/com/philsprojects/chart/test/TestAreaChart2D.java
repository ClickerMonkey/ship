...
import com.philsprojects.chart.painters.PainterArea2D;
...
public class TestAreaChart2D
{
    ...
    final float LINE_ICON_SIZE = 8;
    final Icon[] LINE_ICONS = {
	    new IconCircle(LINE_ICON_SIZE),
	    new IconDiamond(LINE_ICON_SIZE),
	    new IconSquare(LINE_ICON_SIZE),
	    new IconTriangle(LINE_ICON_SIZE),
	    new IconStar(LINE_ICON_SIZE, 5, 0.4, 90),
	    new IconNGon(LINE_ICON_SIZE, 5, 30),
	    new IconPie(LINE_ICON_SIZE * 2, 90, 60, true),
    };
	...
	//=====================================================================
	final SettingsArea2D settings = new SettingsArea2D();
	...
	axisX.setStroke(new BasicStroke(3f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL));
	...
	//=====================================================================
	final DefinitionArea2D[] definitions = new DefinitionArea2D[lists]; 
	for (int i = 0; i < lists; i++)
	{
	    definitions[i] = PainterArea2D.createGradientDefinition(COLORS[i % COLORS.length], 200, 3f);
//	    definitions[i].setPointIcon(LINE_ICONS[i % LINE_ICONS.length]);
//	    definitions[i].setPointIconFill(new FillSolid(COLORS[i % COLORS.length].darker()));
	}
	...
	//=====================================================================
	final PainterArea2D painter = new PainterArea2D(settings, definitions, table);

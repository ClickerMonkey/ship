...
import com.philsprojects.chart.publish.SaveDatatable;
...
public class TestLineChart2D
{
	...
	//=====================================================================
	final Legend legend = new Legend(true, LEGEND_X, LEGEND_Y, LEGEND_WIDTH, LEGEND_HEIGHT, lists);
	...
	component.addKeyListener(new KeyListener() {
		...
		case KeyEvent.VK_S:
			...
			SaveDatatable.open(table, legend);

...
import com.philsprojects.chart.painters.PainterStep2D;
...
public class TestStepChart2D
{
	...
	//=====================================================================
	final PainterStep2D painter = new PainterStep2D(settings, definitions, table);
	...
	plotView.setMaxRight((sets + 1) * SPACING);

...
public class PainterCurve2D 
{
     ...
     * @param datatable
     */
    public PainterCurve2D(SettingsLine2D settings, DefinitionLine2D[] definitions, Datatable datatable)
    {
	...
	case Stacked:
		...
		lines[j].lineTo(offsetX + spacing, bottom - height);
		bottom -= height;
	    }
	    break;
	case Clustered:
		...
		lines[j].lineTo(offsetX + spacing, lineBase - height);
	    }
	    break;
	case Percent:

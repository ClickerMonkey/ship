...
public class TiledLayer implements ICameraObserver, IUpdate
{
	...
	// TODO fix! iteratively 'move' the entity from getLastBounds to getBounds
	// a specific number of units until it reaches getBounds checking collisions
	// along the way. (unit could equal = Math.min(_tileWidth, _tileHeight) / 2)
	...
	// TODO fix! iteratively 'move' the entities from getLastBounds to getBounds
	// a specific number of units until it reaches getBounds checking collisions
	// along the way.

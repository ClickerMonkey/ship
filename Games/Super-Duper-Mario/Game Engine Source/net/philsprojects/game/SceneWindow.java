...
public abstract class SceneWindow extends JFrame implements GLEventListener, KeyListener, MouseMotionListener, MouseListener, WindowListener
{

	private static final long serialVersionUID = 59858228611045854L;
	...
	private float _minDelta = 0.0f;

	public SceneWindow()
	{
		// Set the size according to the size desired by the inherited window
		setSize(this.requestWindowWidth() + 8, this.requestWindowHeight() + 32);
		...
		ScreenManager.initialize(this.requestMaximumScreens(), this.requestWindowWidth(), this.requestWindowHeight());
		...
		// Set how fast this can run TODO option!
	...
	private void initializeWindow()
	{
		...
		// Get the minimum 
		_minDelta = this.requestMinDelta();
	}
	...
	public final void display(GLAutoDrawable drawable)
	{
		...
		this.update(Math.min(_timer.getDeltatime(), _minDelta));
	 ...
	 * 
	 */
	public abstract int requestWindowWidth();

	/**
	 * 
	 */
	public abstract int requestWindowHeight();
	...
	public abstract float requestMinDelta();

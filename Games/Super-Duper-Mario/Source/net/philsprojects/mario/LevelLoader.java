...
public final class LevelLoader implements ITiledLayerFactory
{
	...
	public static final String OBJECT_PACKAGE = "net.philsprojects.mario.objects.";
	...
	public TiledElement createTile(String source)
	{
		...
		else
		{
			try
			{
				Class[] newType = {};
				Object[] newData = {};
				Class tiledElement = Class.forName(OBJECT_PACKAGE + _source, true, Thread.currentThread().getContextClassLoader());

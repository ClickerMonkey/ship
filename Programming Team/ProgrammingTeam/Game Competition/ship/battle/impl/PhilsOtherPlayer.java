 ...
 *
 */
public class PhilsOtherPlayer implements Player
{

	private final Random rnd = new Random();
	
	private final int BOMB_MAP_WIDTH = 7;
	private final int BOMB_MAP_HEIGHT = 7;
	private final int BOMB_MAP_RADIUS = 3;

...
public class BufferStream
{
	 ...
	 */
	public BufferStream(BufferStreamListener listener, BufferFactory factory) 
	{
	...
	/**
	 * Returns a ByteBuffer that can read the underlying data in this stream
	 * but cannot modify it. The returned ByteBuffer will not be able to access
	 * any data written to this stream after this method returns it. 
	 * 
	 * @return
	 * 		The reference to a ByteBuffer which can read the data that exists
	 * 		in this stream at time of invokation.
	 */

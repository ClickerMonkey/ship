...
/**
 * A thread safe set of objects. This provides better performance then any nieve
 ...
 * elements it iterates are a snapshot of the set at the time of invokation.
...
public class ConcurrentSet<E> implements Set<E>
{
	...
	/**
	 * Removes all objects from this set that are equavilent to the given item.
	 * 
	 * @param o
	 ...
	 * of the set at the time of invokation, therefore if the list is going
